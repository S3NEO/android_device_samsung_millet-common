...
BOARD_KERNEL_CMDLINE := androidboot.hardware=qcom vmalloc=400M user_debug=23 msm_rtb.filter=0x37 zcache.enabled=1 zcache.compressor=lz4
...
# SELinux
CONFIG_MILLET_COMMON_SEPOLICY_TYPE := temporary
